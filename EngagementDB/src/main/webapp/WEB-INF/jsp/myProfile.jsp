...
<script>
	...
	<div class="row">
			...
			<c:if test="${resource.base64Jmage != null}">
				<img alt="img" src="data:image/jpeg;base64,${resource.base64Jmage}" height="120" width="110"/>
			</c:if>
			...
			<tr class="break"><td colspan="2"></td></tr>
			<tr><td><b>Supervisor</b></td><td><c:out value = "${supervisorName}" ></c:out> </td><td><Button class="btn btn-info dropdown-toggle" id="changeSupervisor">Change supervisor</Button></td></tr>
			<tr class="break"><td colspan="2"></td></tr>
			...
			<input type="submit" id="updateSupervisor" value="update" style="visibility:hidden"/>
				</form>
			...
			<input type="submit" id="updateContact" value="update" style="visibility:hidden"/>
	</form>
