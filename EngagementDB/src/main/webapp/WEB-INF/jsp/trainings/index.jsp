	...
	function openBcp() {
		window
				.open(
						...
						config = 'toolbar=no, menubar=no, scrollbars=no, resizable=yes, location=no, directories=no, status=no');
	}
...
<body id="home">
	<div data-role="page">
		<div data-role="header" data-position="absolute">
			<hr>
			<div class="header-data">HCSC UNIVERSITY</div>
			<hr>
			<p align="center" style="color:red">NOTE: Every slide has been associated with TIMER, Thus only after certain amount of time the user will be able to change the slide.</p>
		</div>
			...
			<div class="c">
				<div>
					<div class="r">
						...
						<a class="mouse" onclick="openContinuous()"><div>
				...
				<div>
					<div class="r">
						...
						<a class="mouse" onclick="openHealth()"><div>
				...
				<div>
					<div class="r">
						...
						<a class="mouse" onclick="openOrg()"><div>
		...
		<div data-role="footer" data-position="absolute">
			<h1>
				<a href="https://accenture.com">© 2017 Accenture All Rights
					Reserved. Accenture Highly Confidential. For Internal Use Only.</a>
			</h1>
		</div>
	</div>
	<script
