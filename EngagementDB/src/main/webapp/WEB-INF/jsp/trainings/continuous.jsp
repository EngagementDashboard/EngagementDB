...
<body>
	<div class="reveal">
		...
		<div class="slides" align="center">
			<section id="slide1">
			<div id="innovation">
				<p style="color: white;">Please select one of the following:</p>
				<br> <a href="#/slide2" onclick="timer()">Innovation at a
					Glance</a><br> <br> <a href="toolassets.htm"
					onclick="timer()">Tool Assets</a> <br> <br> <a
					href="navriti.htm" onclick="timer()">Navriti Framework</a><br>
				<br> <br> <a href="hcscMenu.htm" class=mouse><img
					src="images\home-65.png" height="42" width="42"></a>
			</div>
			</section>
