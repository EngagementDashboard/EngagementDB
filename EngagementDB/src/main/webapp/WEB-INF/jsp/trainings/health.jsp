...
<body>
	<div class="reveal">
		...
		<div class="slides" align="center">
			<section id="slide1">
					<div id=health>
					<p style="font-size:40px; color:white">Please select one of the following</p><br>
					<a href="#/slide1" onclick="timer()">Health Overview </a><br> 
					<a href="healthcareday1.htm" onclick="timer()">Health Care Day 1</a> <br>
					<a href="healthcareday2.htm onclick="timer()">Health Care Day 2</a> <br>
					<a href="healthcareday3.htm" onclick="timer()">Health Care Day 3</a> <br>
					<a href="healthcareday4.htm" onclick="timer()">Health Care Day 4</a> <br>
					<a href="healthcareday5.htm" onclick="timer()">Health Care Day 5</a> <br>
					<a href="healthcareday6.htm" onclick="timer()">Health Care Day 6</a> <br><br>
					<!-- <input type="button" onclick="home()" value="HOME"> -->
					
					</div>
					<a href="hcscMenu.htm" class=mouse><img src="images\home-65.png" height="42" width="42" align="middle"></a>
			</section> 
			<section id="slide2">
			...
			<section id="slide73">
				...
				<p align="center"><a href="health.htm">Click Here</a> to redirect to Navriti Menu page.</p>
			</section>
		</div>
	</div>
